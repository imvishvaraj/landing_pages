...
class Page(models.Model):
    ...
    jumbtron_text_color = models.CharField(max_length=7, default='#000000', validators=[layout_validators])
    jumbtron_bg_color   = models.CharField(max_length=7, default='#eeeeee', validators=[layout_validators])
